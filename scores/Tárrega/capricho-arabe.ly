...
\header {
  ...
  tagline = \markup{ \italic \small "Édition du 20/04/2026 par Benoît Pin"}
  %{
  sources :
...
\score {
  \new Staff {
    ...
    \unfoldRepeats
    \removeWithTag #'(coda manurepeats)
    \zique

    \removeWithTag #'(repeat1 manurepeats)
    \zique
  }
